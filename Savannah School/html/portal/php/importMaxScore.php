...
sec_session_start();
	...
	$sql = "SELECT MAX(score) FROM $tableName WHERE difficulty = $difficultyInput AND username = ANY(SELECT studentUsername from students where teacherId = (SELECT teacherID from teachers where username = '$username'))";
