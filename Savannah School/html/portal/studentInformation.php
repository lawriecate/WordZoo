...
<html lang="en" style="min-height: 979px;">
  <head>
    <meta charset="utf-8">
    <title>Portal Student Information</title>
  ...
  <body onload=" setTeacherID(); loadStudents(); initSelection();">
    <div class="container">
	    	<div class="header">
					...
					<div class ="col1">
						<div class ="controls">
							<form>
                              ...
                              <select id="namelist" name="username"></select>
                              </select>
                              <select id = "game">
						...
						<div class = "graph">
							<center>
								...
								<script type="text/javascript" src="js/drawChartStudent.js"></script>	
							</center>
						<div class = "stats">
