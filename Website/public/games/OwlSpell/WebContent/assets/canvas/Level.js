...
Level.prototype.preload = function () {
	//Load JSON Images
	var ROOT_URL = 'http://localhost:3000/games/OwlSpell/WebContent/';
	this.load.pack('PlayState', 'http://localhost:3000/games/OwlSpell/WebContent/assets/pack.json');
	assets = new Array();
	...
	//Load the Assets
	var ROOT_URL = 'http://localhost:3000/games/OwlSpell/WebContent/';
	this.load.image('Apple',ROOT_URL+'assets/testAssets/Apple.png');
	this.load.image('Bear' ,ROOT_URL+'assets/testAssets/Bear.png');
	this.load.image('Bird' ,ROOT_URL+'assets/testAssets/Bird.png' );
	this.load.image('Boat' ,ROOT_URL+'assets/testAssets/Boat.png');
	this.load.image('Book' ,ROOT_URL+'assets/testAssets/Book.png');
	this.load.image('Car' ,ROOT_URL+'assets/testAssets/Car.png');
	this.load.image('Cheese' ,ROOT_URL+'assets/testAssets/Cheese.png');
	this.load.image('Cone' ,ROOT_URL+'assets/testAssets/Cone.png');
	this.load.image('Dog' ,ROOT_URL+'assets/testAssets/Dog.png');
	this.load.image('Hat' ,ROOT_URL+'assets/testAssets/Hat.png')
	this.load.image('highLightCircle',ROOT_URL+'assets/highlightCircle.png');
    this.load.spritesheet('explosion', ROOT_URL+'assets/explosionFull.png', 256, 256, 32);
    //Frame Width, Frame Height, Frame Max, margin,spacing
    this.load.spritesheet('deathExplosion',ROOT_URL+'assets/deathExplosion.png',148.1,187,27);
