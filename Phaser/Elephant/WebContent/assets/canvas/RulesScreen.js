...
{	
	...
	item1 = this.game.add.sprite(555, 250, randomWords[0]);
	item2 = this.game.add.sprite(998, 250, randomWords[1]);
...
{	
	...
	// Set incorrect pictures
	item0 = this.game.add.sprite(120, 250, randomWords[2]);
	item1 = this.game.add.sprite(555, 250, randomWords[3]);
